...
import type { Alumnus, Member as TMember } from "./_components/types";

const members: TMember[] = [
  {
    name: "Tomás Ramírez Reina, FRSC",
    role: "Principal Investigator",
    description: (
      <>
        <p>
          Tomás Ramírez Reina, FRSC is a full professor of Inorganic Chemistry at
          the University of Seville and the coordinator of the Catalysis Unit at
          the Materials Sciences Institute (ICMS), University of Seville–CSIC. He
          holds several international appointments such as visiting professor
          (2019, 2024, 2026) at HUST University (China), visiting scientist (2020)
          at the Dalian Institute of Chemical Physics (China) and visiting
          professor (2022–present) in the School of Chemistry &amp; Chemical
          Engineering at the University of Surrey (UK), where he founded the
          Catalysis-Engineering Unit and worked as Group Leader for several years.
          Tomás holds a PhD in Chemistry with a background in heterogeneous
          catalysis, reaction engineering and material sciences.
        </p>
        <p>
          His research in catalysis has been recognised by the international
          community with multiple awards, including the EFCATS student award
          (2013), the Spanish Society of Catalysis best PhD award (2014), the
          extraordinary PhD award by the University of Seville (2014), Young
          Scientist of the Year 2017 (Seville city council), the Royal Academy of
          Sciences of Seville Science award (2018), the Chinese Academy of
          Sciences President award (2020), the FISOCat junior award (2022), the
          Losada-Villasante award (2022) for his research in circular economy, and
          the SUSCHEM Innova award (2025). He has also been finalist of the
          prestigious IChemE awards in 2016 and 2017 in the category of Young
          Academic Researcher. He has co-authored over 230 peer-reviewed
          publications in highly reputed journals (including Nature family,
          Chemical Reviews, PECS, Applied Catalysis B, JACS, Angewandte Chemie,
          etc.), more than 100 conference contributions (22 invited
          lectures/keynotes), 6 book chapters, has licensed 7 patents (2
          transferred to industry) and is the editor of 3 textbooks for RSC, Wiley
          and Elsevier.
        </p>
        <p>
          Prof. Reina has supervised 30+ MSc/MEng and 17 PhD projects (6 ongoing),
          and is presently mentoring several postdoctoral researchers and junior
          academics. He has participated as PI/Co-I on multiple projects in the
          area of energy, materials and sustainable chemical technologies
          sponsored by institutions such as ERC, EU-H2020, EU-Horizon Europe, the
          Spanish Ministry of Science, AEI, EPSRC, Royal Society, British Council
          and the Chinese Academy of Sciences. He was elected Fellow of the Royal
          Society of Chemistry in 2021 and since 2022 is included in the Stanford
          list of the world&apos;s top-2% most influential scientists in his
          field.
        </p>
      </>
    ),
      ...
      <header className="px-4 pb-8 sm:px-6 sm:pb-16 sm:text-center md:px-8">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 md:px-8">
          ...
          <p className="mt-4">
            ...
            prestigious grant from the European Research Council and hosted at the
            Materials Science Institute (University of Seville–CSIC), within
      ...
      <section className="mb-8 space-y-8 pt-8 sm:mb-10 sm:space-y-10 sm:pt-10 md:mb-12 md:space-y-12 md:pt-12">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 md:px-8">
          ...
          <ul className="mt-4 space-y-6">
            {alumni.map(({ name, thesis, year }, i) => (
              <li key={i}>
                <h3 className="text-lg font-semibold">{name}</h3>
                <p className="text-accent-500 text-sm font-semibold">{year}</p>
